...
const services = [
  {
    title: "Residential Cleaning in Airdrie",
    description:
  ...
  {
    title: "Commercial Cleaning in Airdrie",
    description:
  ...
  {
    title: "Mobile Vehicle Cleaning in Airdrie",
    description:
  ...
  {
    title: "Seasonal Property Services in Airdrie",
    description:
    ...
    <div className="container-custom mx-auto">
      <div className="mx-auto mb-14 max-w-4xl text-center">
        <h2 className="text-3xl font-extrabold text-[#0B4E9B] md:text-5xl">
          Cleaning Options for Airdrie Homes and Businesses
        </h2>
      ...
      <div className="mx-auto mt-14 max-w-3xl text-center">
        <h2 className="text-2xl font-extrabold text-[#0B4E9B] md:text-4xl">
          Flexible Cleaning for Airdrie Properties
        </h2>
        <p className="mt-4 leading-relaxed text-gray-700">
          We offer transparent quotes and dependable cleaning services for homes and businesses across Airdrie. Appointment availability depends on the service, location and requested schedule.
        </p>
        <p className="mt-4 leading-relaxed text-gray-700">
