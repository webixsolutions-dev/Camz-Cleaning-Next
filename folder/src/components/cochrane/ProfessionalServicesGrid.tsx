...
const services = [
  {
    title: "Residential Cleaning in Cochrane",
    description:
  ...
  {
    title: "Commercial Cleaning in Cochrane",
    description:
  ...
  {
    title: "Mobile Vehicle Cleaning in Cochrane",
    description:
  ...
  {
    title: "Seasonal Property Services in Cochrane",
    description:
    ...
    <div className="container-custom mx-auto">
      <div className="mx-auto mb-14 max-w-4xl text-center">
        <h2 className="text-3xl font-extrabold text-[#0B4E9B] md:text-5xl">
          Cleaning Options for Cochrane Properties
        </h2>
      ...
      <div className="mx-auto mt-14 max-w-3xl text-center">
        <h2 className="text-2xl font-extrabold text-[#0B4E9B] md:text-4xl">
          Cleaning Plans for Cochrane Homes and Businesses
        </h2>
        <p className="mt-4 leading-relaxed text-gray-700">
          Camz Cleaning provides one-time and recurring options for Cochrane properties, with the scope and schedule confirmed according to the requested service.
        </p>
        <p className="mt-4 leading-relaxed text-gray-700">
