...
export const jsonLdSchemas = {
  ...
  "/airbnb-cleaning-services/": servicePageSchema({
    path: "/airbnb-cleaning-services/",
    name: "Airbnb & Vacation Rental Cleaning Services in Calgary",
    description:
      "Professional Airbnb and vacation rental cleaning services in Calgary for guest turnovers, kitchens, bathrooms, bedrooms and living areas.",
    serviceType: "Airbnb and vacation rental cleaning",
    areaServed: allServiceAreas,
    offers: [
  ...
  "/cleaning-products-and-equipment/": {
    ...
    "@graph": [

      {
        ...
        "@id": `${SITE_URL}/cleaning-products-and-equipment/#webpage`,

        url: `${SITE_URL}/cleaning-products-and-equipment/`,

        name: "Cleaning Products & Equipment | Camz Cleaning",

        description:

          "Learn about the cleaning products and equipment used by Camz Cleaning for professional cleaning services.",
