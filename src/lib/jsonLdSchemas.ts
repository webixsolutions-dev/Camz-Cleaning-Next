...
export const jsonLdSchemas = {
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
         {
            ...
            position: 3,
            name: "Airbnb & Short-Term Rental Cleaning",
            url: `${SITE_URL}/airbnb-cleaning-services/`,
          },
          {
            "@type": "ListItem",
            position: 4,
    ...
    "@graph": [
      {
        ...
        name: "Cleaning Products & Equipment We Use | Camz Cleaning Calgary",
        description:
  ...
  "/airbnb-cleaning-services/": servicePageSchema({
    ...
    name: "Airbnb & Short-Term Rental Cleaning in Calgary",
    description:
    ...
    serviceType: "Airbnb and short-term rental cleaning",
    areaServed: allServiceAreas,
    offers: [
      ...
      "Visual maintenance and damage reporting",
    ],
  }),
} as const;
