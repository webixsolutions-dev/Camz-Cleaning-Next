...
export default function Header() {
  ...
  const aboutLinks = [
    { name: "ABOUT US", href: "/about-us" },
    {
      ...
      href: "/cleaning-products-and-equipment",
    },
  ];
    ...
    <header className="w-full shadow-sm relative z-50">
      ...
      <div className="bg-white">
        <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between gap-3 px-4 py-3 sm:px-5 lg:gap-4 lg:px-6 lg:py-3.5 xl:gap-5 xl:px-7 2xl:px-8">
          ...
          <Link
            href="/"
            className="-ml-2 shrink-0 self-center sm:-ml-3 lg:-ml-4"
          >
            <Image
              src="/logo.webp"
              alt="Camz Cleaning"
          ...
          <nav className="hidden min-w-0 flex-1 items-center justify-center gap-2.5 whitespace-nowrap text-[12px] font-semibold text-[#0B4E9B] lg:flex xl:gap-4 xl:text-[14px] 2xl:gap-5 2xl:text-[15px]">
            ...
            <div className="relative group py-2">
              <button
                ...
                className="flex items-center gap-1.5 cursor-pointer transition-colors group-hover:text-[#00B7EB]"
              >
                ABOUT US
                <ChevronDown size={16} />
              </button>

              <div className="absolute left-1/2 top-[calc(100%+8px)] z-50 hidden w-72 -translate-x-1/2 rounded-2xl border border-slate-200 bg-white p-2 shadow-2xl shadow-slate-300/50 group-hover:block">
                {aboutLinks.map((link) => (
                  <Link
                    key={link.name}
                    href={link.href}
                    className="block rounded-xl px-4 py-3 text-sm font-bold transition-all hover:bg-blue-50 hover:text-[#00B7EB]"
                  >
                    {link.name}
                  </Link>
                ))}
          ...
          <div className="hidden shrink-0 lg:block">
            {isAuthed ? (
              <button
                ...
                className="bg-[#0B4E9B] whitespace-nowrap text-white px-4 xl:px-6 py-2.5 xl:py-3 rounded-lg text-[13px] xl:text-[14px] font-bold hover:bg-[#00B7EB] transition-all cursor-pointer"
              >
                Dashboard
              </button>
            ) : (
              <Link href="/login">
                <button className="bg-[#0B4E9B] whitespace-nowrap text-white px-4 xl:px-6 py-2.5 xl:py-3 rounded-lg text-[13px] xl:text-[14px] font-bold hover:bg-[#00B7EB] transition-all">
                  Login
                </button>
              </Link>
            )}
          ...
          {/* MOBILE MENU BUTTON */}
          <button
            className="lg:hidden text-[#0B4E9B]"
              ...
              <div className="p-6">
                {isAuthed ? (
                  <button
                    ...
                    className="w-full rounded-md bg-[#0B4E9B] py-3 text-white cursor-pointer"
                  >
                    Dashboard
                  </button>
                ) : (
                  <Link href="/login" onClick={() => setIsOpen(false)}>
                    <button className="w-full rounded-md bg-[#0B4E9B] py-3 text-white">
                      Login
                    </button>
                  </Link>
                )}
