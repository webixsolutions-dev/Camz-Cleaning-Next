      ...
      <section className="mb-4 rounded-2xl border border-slate-200 bg-white p-4 sm:p-5">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <label className="text-[13px] font-semibold text-slate-500 sm:col-span-2">
            Address
            <input className={`${fieldClass} mt-1`} value={settings.address_line1 || ""} disabled={!isAdmin} onChange={(event) => update("address_line1", event.target.value)} placeholder="Street address" />
          </label>
          <label className="text-[13px] font-semibold text-slate-500 sm:col-span-2">
            Address line 2
